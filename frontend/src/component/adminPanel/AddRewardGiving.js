...
class AddRewardGiving extends Component {
  constructor(props) {
    super(props);
    this.state = {
      rewards: [],
  ...
  render() {
    const { rewards, loading, newRewardType, newRewardGift, openModal } =
      this.state;
                  ...
                  <div className="">
                    <div style={{ display: "flex", flex: 2 }}>
                      <textarea
                        ...
                        type="text"
                        placeholder="Kind words toward winner"
                        value={newRewardGift}
                        onChange={(e) =>
...
export default AddRewardGiving;
