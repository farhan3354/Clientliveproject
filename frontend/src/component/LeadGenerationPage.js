...
export default function LeadGenerationPage() {
  ...
  // Function to handle click event on play button
  ...
  return (
    <div>
      <Helmet>
        ...
        <link rel="stylesheet" href="assets/css/glightbox.min.css"></link>

        <link rel="stylesheet" href="assets/css/lineicons.css"></link>
            ...
            <div class="row">
              <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg">
                  <img id="logo" src="publiclogo.webp" alt="Logo" />
                  <button
                  ...
                  >
                    <ul id="nav" class="navbar-nav ms-auto">
                      <li class="nav-item">
                        <a class="page-scroll" href="#how-work">
                          Mastery Website
                        </a>
                      </li>
                      <li class="nav-item">
                        <a class="page-scroll" href="#pricing">
                          Mastery Facebook Group
                        </a>
                      </li>
                      <li class="nav-item">
      ...
      <section
        id="home"
        class="hero-area bg_cover"
        style={{ background: "url('assets/images/hero-bg.png')" }}
      >
        <div class="container">
            ...
            <div class="col-xl-6 col-lg-6">
              <div class="hero-content">
                <h2 class="wow fadeInUp" data-wow-delay=".2s">
                  Welcome to <br></br>Mastery Martial Art
                </h2>
                <p class="wow fadeInUp" data-wow-delay=".4s">
                  Commited to serve for future of kids all over America offering
                  different programs to provide a platform where they can learn.
                  <br></br>
                  Be a Leader - Join Mastery Today
                </p>
                <div class="hero-btns">
                  <a
                    ...
                    <div className="modal">
                      <div className="modal-content">
                        ...
                        <div className="video-player">
                          <video controls>
                            <source
                              src="assets/images/masteryvideo.mp4"
                              type="video/mp4"
                            />
              ...
              <div class="counter-up">
                <div class="single-counter wow fadeInUp" data-wow-delay=".2s">
                  <span id="secondo" class="countup">
                    <CountUpComponent end={1100} />
                  </span>
                  <span>New Students</span>
                </div>
                <div class="single-counter wow fadeInUp" data-wow-delay=".3s">
                  <span id="secondo" class="countup">
                    <CountUpComponent end={35000} />
                  </span>
            ...
            <div class="col-xl-6 col-lg-6">
              <div class="hero-img">
                ...
                <img
                  ...
                  alt=""
                  class="img-screen screen-1 wow fadeInUp"
                  data-wow-delay=".25s"
                />
                <img
                  src="assets/images/images3.jpeg"
                  alt=""
                  class="img-screen screen-2 wow fadeInUp"
                  data-wow-delay=".3s"
                />
                <img
                  src="assets/images/images.jpeg"
                  alt=""
                  class="img-screen screen-3 wow fadeInUp"
                  data-wow-delay=".35s"
                />
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-xl-5 col-lg-6">
              <div class="how-work-img text-center text-lg-left">
                <img
                  src="assets/images/download-img.svg"
                  alt=""
                  class="w-100 wow fadeInLeft"
                  data-wow-delay=".2s"
                />
                <img
                  src="assets/images/dots-shape.svg"
                  alt=""
                  class="shape dots-shape wow fadeInUp"
                  data-wow-delay=".3s"
                />
              </div>
            </div>
              ...
              <div class="how-work-content-wrapper">
                ...
                <div class="how-work-accordion accordion-style">
                  <div class="accordion" id="accordionExample">
                    <div
                      class="single-accordion mb-30 wow fadeInUp"
                      data-wow-delay=".2s"
                    >
                      <div class="accordion-btn">
                        <button
                          class="btn-block text-start collapsed"
                          type="button"
                          data-bs-toggle="collapse"
                ...
                <div class="download-btn wow fadeInUp" data-wow-delay=".5s">
                  <a href="javascript:void(0)" class="main-btn btn-hover">
                    Download Now
                  </a>
                </div>
              </div>
          ...
          <div class="row">
           ...
           "
                ...
                <div class="tab-content" id="pills-tabContent">
                  <div
                    class="tab-pane fade price-tab show active"
                    id="pills-month"
                    role="tabpanel"
                    ...
                    <div class="row">
                      <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-price text-center">
                          ...
                          <h4 class="package-price mb-20">$5.0</h4>
                          ...
                          <a
                            href="javascript:void(0)"
                            class="btn-hover price-btn main-btn"
                          >
                            Buy Now
                          </a>
                        </div>
                      ...
                      <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-price text-center active">
                          ...
                          <h4 class="package-price mb-20">$15</h4>
                          <ul class="package-details">
                            <li>15 Cards</li>
                      ...
                      <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-price text-center">
                          ...
                          <h4 class="package-price mb-20">$99</h4>
                          <ul class="package-details">
            ...
            <div class="row">
              <div class="col-xl-6 col-lg-6 offset-1 col-11">
                <div class="download-content">
                  <div class="section-title">
                    <h2
                      class="mb-30 text-white wow fadeInUp"
                      data-wow-delay=".2s"
                    >
                      Download the app now
                    </h2>
                    <p
                      class="mb-40 text-white wow fadeInUp"
                      data-wow-delay=".35s"
                    >
                      Lorem ipsum dolor sit amet, consetetur sadipscing elitr,
                      sed diamnonumy eirmod tempor invidunt labore.
                    </p>
                  </div>
                  <div class="download-btns">
                    <a
                      href="javascript:void(0)"
                      class="btn-hover download-btn me-4 wow fadeInUp"
                      data-wow-delay=".45s"
                    >
                      ...
                      <span class="text">
                        App Store <b>Download now</b>{" "}
                      </span>
                    </a>
                    <a
                      href="javascript:void(0)"
                      class="btn-hover download-btn wow fadeInUp"
                      data-wow-delay=".55s"
                    >
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
              <div class="footer-widget wow fadeInUp" data-wow-delay=".8s">
                ...
                >
                  ...
                  <button
                    id="subscribe"
                    class="btn-hover main-btn text-end"
                    type="submit"
                  >
                    Submit
                  </button>
